...
public final class SleepingBarberConfig {
    ...
    protected static int N = 10; //5_000; // num haircuts
    protected static int W = 4; //1_000; // waiting room size
    protected static int APR = 1; //1_000; // average production rate
    protected static int AHR = 1; //1_000; // avergae haircut rate
