...
public final class ProdConsBoundedBufferConfig {
    ...
    protected static int numProducers = 5; //40;
    protected static int numConsumers = 5; //40;
    protected static int numItemsPerProducer = 10; //1_000;
    protected static int prodCost = 1; //25;
    protected static int consCost = 1; //25;
